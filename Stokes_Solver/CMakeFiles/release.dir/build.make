...
CMakeFiles/release:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/Users/colegruninger/Stokes_solver/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Switching CMAKE_BUILD_TYPE to Release"
	/usr/local/Cellar/cmake/3.22.2/bin/cmake -DCMAKE_BUILD_TYPE=Release /Users/colegruninger/Stokes_solver
	/usr/local/Cellar/cmake/3.22.2/bin/cmake -E echo "***"
	/usr/local/Cellar/cmake/3.22.2/bin/cmake -E echo "*** Switched to Release mode. Now recompile with:  \$$ make"
	/usr/local/Cellar/cmake/3.22.2/bin/cmake -E echo "***"
