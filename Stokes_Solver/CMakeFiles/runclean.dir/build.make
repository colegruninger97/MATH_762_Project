...
CMakeFiles/runclean:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/Users/colegruninger/Stokes_solver/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "runclean invoked"
	/usr/local/Cellar/cmake/3.22.2/bin/cmake -E remove *.log *.gmv *.gnuplot *.gpl *.eps *.pov *.vtk *.ucd *.d2
